...
# from business_logic.services.api_key_manager import get_api_key
# api_key = get_api_key()  # Gets current key
# rotate key if needed: from business_logic.services.api_key_manager import rotate_api_key
