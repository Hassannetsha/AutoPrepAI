...
class IntentColumnResolver(ParameterResolver):
    """
    Resolves parameters by extracting columns and options from business_logic.cleaning_coordinator.intents.
    """
    ...
    def _extract_columns_from_intents(self, intents: List) -> List[str]:
        """Extract column names from business_logic.cleaning_coordinator.intents that match our intent names."""
        columns = []
